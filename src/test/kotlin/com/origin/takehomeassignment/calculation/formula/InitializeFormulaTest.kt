...
internal class InitializeFormulaTest {
    ...
    fun convert(
        ...
        val initializeFormula = InitializeFormula()
        val scoreCalculationDetailList = initializeFormula.execute(riskCalculationRequest)
